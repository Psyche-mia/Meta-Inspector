...
for i in "${!depth[@]}";do
    ...
    ## train on the VisA dataset
        ...
        save_dir=./checkpoints/${base_dir}/2024_08_07/
        CUDA_VISIBLE_DEVICES=${device} python train_meta.py --dataset mvtec --train_data_path /mnt/IAD_datasets/mvtec_anomaly_detection \
        --save_path ${save_dir} \
