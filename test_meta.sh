...
for i in "${!depth[@]}";do
    ...
    ## train on the mvtec dataset
        ...
        CUDA_VISIBLE_DEVICES=${device} python test_meta.py --dataset mvtec \
        --data_path /mnt/IAD_datasets/mvtec_anomaly_detection --save_path ./results/${base_dir}/zero_shot \
        --checkpoint_path ${save_dir}epoch_30.pth \
