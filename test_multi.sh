...
for i in "${!depth[@]}";do
    ...
    ## train on the mvtec dataset
        ...
        save_dir=./checkpoints/${base_dir}/2024_08_15/
        CUDA_VISIBLE_DEVICES=${device} python test_multi_SA.py --dataset mvtec \
        --data_path /mnt/IAD_datasets/mvtec_anomaly_detection --save_path ./results/${base_dir}/2024_07_23 \
        --checkpoint_path ${save_dir}epoch_3.pth \
